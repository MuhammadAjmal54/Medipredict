...
const Appointment = () => {
    ...
    const daysOfWheek = ['SUN', 'MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT']
                ...
                <div className='flex items-center gap-3 w-full overflow-x-scroll mt-4'>
                    {
                        ...
                        docSlots.length && docSlots.map((item, index) => (
                            <div onClick={() => setsloteIndex(index)} className={`text-center py-6 min-w-16 rounded-full cursor-pointer ${slotIndex === index ? 'bg-[#5F6FFF] text-white' : 'border border-gray-200'}`} key={index}>
                                <p>{item[0] && daysOfWheek[item[0].datetime.getDay()]}</p>
